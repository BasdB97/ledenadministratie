        ...
        <?php if ($_SESSION['userRole'] == 'admin' || $_SESSION['userRole'] == 'penningmeester'): ?>
          <li>
            <a href="<?php echo URL_ROOT; ?>/contributions/index"
              ...
              <span>Boekjaar en contributie</span>
            </a>
          </li>
        <?php endif; ?>
        <li>
          <a href="<?php echo URL_ROOT; ?>/yearselection/index"
            class="flex items-center px-4 py-2 text-gray-300 hover:bg-primary-dark hover:text-white rounded-lg mx-2">
